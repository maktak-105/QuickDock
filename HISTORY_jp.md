...
公開バージョンは **1.1.0**。下の 1.0.1〜3.2.2 は未公開の開発記録（消していない）。

## 1.1.0 — 2026-09-23

- タスクバーおよび Alt+Tab から非表示（WS_EX_TOOLWINDOW）
- トレイアイコンの左クリックでドックを前面化

## 1.0.0 — 2026-09-20（初公開）

- 枠なしフローティングドック。Explorer からドロップして格納
- 右クリックメニューから Windows 起動時の実行を切り替え
- ホバー展開（横 6 個、以降は下段）、名前表示、並べ替え
- 右クリック: 管理者として実行 / 削除
- 管理者起動だと Explorer からドロップできない（UIPI）

## 3.2.2 — 2026-09-20（未公開）
...
- `tests\selftest.ps1` で登録・展開・起動を自動確認
